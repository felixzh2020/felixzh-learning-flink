...
/***
 ...
 at com.felixzh.learning.flink.format.debezium_json.MySqlCDC2Kafka.main(MySqlCDC2Kafka.java:60)
 Caused by: org.apache.flink.table.api.ValidationException: Error creating sink format 'debezium-json' in option space 'debezium-json.'.
 ...
 ... 18 more
 Caused by: java.lang.UnsupportedOperationException: Debezium format doesn't support as a sink format yet.
 at org.apache.flink.formats.json.debezium.DebeziumJsonFormatFactory.createEncodingFormat(DebeziumJsonFormatFactory.java:107)
